                    ...
                    {friends.map((friend) => (
                      <div key={friend.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-accent transition-colors">
                        <div className="flex items-center gap-3">
                          <div className="relative cursor-pointer" onClick={() => navigate(`/profile/${friend.id}`)}>
                            <Avatar>
                          ...
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              {friend.status === "Online" ? <span className="text-green-500 font-medium">● Online</span> : friend.email}
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="space-y-3">
                    {friendRequests.map((request) => (
                      <div key={request.id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-3">
                          <Avatar className="cursor-pointer" onClick={() => navigate(`/profile/${request.id}`)}>
