...
const MATRIX_ICONS = {
  "caro-5": [
    [2, 2, "#ef4444"], [3, 3, "#ef4444"], [4, 4, "#ef4444"], [5, 5, "#ef4444"], [6, 6, "#ef4444"], [7, 7, "#ef4444"],
    [2, 7, "#ef4444"], [3, 6, "#ef4444"], [4, 5, "#ef4444"], [5, 4, "#ef4444"], [6, 3, "#ef4444"], [7, 2, "#ef4444"],
    [0, 0, "#3b82f6"], [0, 9, "#3b82f6"], [9, 0, "#3b82f6"], [9, 9, "#3b82f6"]
  ],

  "caro-4": [
    [2, 3, "#f59e0b"], [3, 3, "#f59e0b"], [4, 3, "#f59e0b"], [5, 3, "#f59e0b"],
    [5, 2, "#f59e0b"], [5, 4, "#f59e0b"], [5, 5, "#f59e0b"],
    [3, 2, "#f59e0b"], [2, 2, "#f59e0b"]
  ],

  "tic-tac-toe": [
    [3, 4, "#ffffff"], [4, 4, "#ffffff"], [5, 4, "#ffffff"], [6, 4, "#ffffff"],
    [4, 3, "#ffffff"], [4, 5, "#ffffff"], [4, 6, "#ffffff"],
    [5, 5, "#ef4444"], [3, 3, "#3b82f6"]
  ],

  "snake": [
    [4, 3, "#22c55e"], [4, 4, "#22c55e"], [4, 5, "#22c55e"],
    [3, 5, "#22c55e"], [3, 6, "#4ade80"],
    [6, 7, "#dc2626"]
  ],

  "match-3": [
    [3, 3, "#ec4899"], [3, 4, "#ec4899"], [3, 5, "#ec4899"],
    [5, 3, "#eab308"], [5, 4, "#a855f7"], [5, 5, "#06b6d4"],
    [4, 4, "#ffffff"]
  ],

  "memory": [
    [3, 3, "#8b5cf6"], [6, 6, "#8b5cf6"],
    [3, 6, "#f43f5e"], [6, 3, "#f43f5e"],
    [4, 4, "#64748b"], [4, 5, "#64748b"], [5, 4, "#64748b"], [5, 5, "#64748b"]
  ],

  "drawing": [
    [2, 2, "#ef4444"], [3, 3, "#f97316"], [4, 4, "#eab308"], [5, 5, "#22c55e"],
    [6, 6, "#3b82f6"], [7, 7, "#8b5cf6"], [8, 8, "#db2777"]
  ]
};
...
export default function HomePage() {
  ...
  const renderMatrix = () => {
    ...
    return (
      <div className="grid grid-cols-10 gap-2 bg-black p-6 rounded-xl border-[8px] border-slate-800 shadow-[0_0_40px_rgba(0,0,0,0.8)]">
        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center my-auto">
          ...
          <div className="flex flex-col items-center space-y-8">
            <div className="flex flex-col items-center">
              {loading ? (
                <div className="h-[360px] w-[360px] flex items-center justify-center bg-slate-900 rounded-xl border-4 border-slate-800">
          ...
          <div className="space-y-6">
            {!loading && games[selectedIndex] && (
              <div className="animate-in slide-in-from-right duration-500">
                <h1 className="text-6xl font-black italic uppercase text-transparent bg-clip-text bg-gradient-to-br from-white to-slate-500">
